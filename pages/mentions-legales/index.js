    ...
    return (
        <div className="min-h-screen text-white">
            ...
            <main className="flex flex-col items-center text-left py-16 px-6 max-w-4xl mx-auto">
                <h1 className="text-5xl font-bold text-gray-100 mb-8 text-center">Mentions légales</h1>

                {/* SECTION 1 - Introduction */}
                <section className="mb-12">
                    <h2 className="text-3xl font-bold text-green-400 mb-4">1. Éditeur du site</h2>
                    <p className="text-gray-300 text-lg leading-relaxed">
                    Le site Fanatsy (accessible à l’adresse fanatsy.dev) est édité par :
